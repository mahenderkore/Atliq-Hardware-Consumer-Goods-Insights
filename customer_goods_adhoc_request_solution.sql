...
(
select B.segment ,
count(distinct case when A.fiscal_year = '2020' then B.product_code end) as 'product_count_2020',
count(distinct case when A.fiscal_year = '2021' then B.product_code end) as 'product_count_2021',
((count(distinct case when A.fiscal_year = '2021' then B.product_code end))-
(count(distinct case when A.fiscal_year = '2020' then B.product_code end))) as 'difference'
